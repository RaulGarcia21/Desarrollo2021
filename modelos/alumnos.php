...
class Alumnos extends BaseDeDatos {
    ...
    public function Add($nombre, $direccion, $telefono, $lab1, $lab2, $parcial){
        $result=$this->conexion->query("insert into alumnos set Nombre='{$nombre}', Direccion='{$direccion}', Telefono='{$telefono}', Laboratorio1='{$lab1}', Laboratorio2='{$lab2}', Parcial='{$parcial}'");
        return true;
    }
